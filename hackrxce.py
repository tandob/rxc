...
if(expirydate>today):
    ...
    while(True):
        print("My banking name is Rajjab khan")
        ...
        print(f"If It Does'nt Open Contact Me On Telegram {yellow} LOVE IS LIFE 💘")
        print(f"{neon}*---------*----------*-------------*----------*")
        print(f"{red}*---------*----------*-------------*----------*")
        print("payhere--- UPI : ")
        print(f"{yellow}UPI1 : 9001690334@upi")
        print("phone pe : 9001690334")
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            period=rava
            hero()
            #period("Sorry too many people(>0.1) using hack in same time ")
            sys.exit(" \n \n \n Contact on Telegram LOVE IS LIFE 💘")
        elif(bhai==night):
            clear()
            print("----------Your play time-----------")
